...
async def zee5_capture(bot, update):
    ...
    if "zee5" in update.text:
        ...
        await update.reply_text("I can download from Zee5 links only! Use @moviezbarn Visit t.me/moviezbarn 😇", quote=True)
        return
